...
{
	uint32_t uiPllCtrl;
	uint32_t uiPllCtrlSet;
	uint32_t uiPllCtrlClr;
} T_PLL_CTRL;

typedef struct
{
    volatile uint32_t uiRootCtrl;
    volatile uint32_t uiRootSet;
    volatile uint32_t uiRootClr;
    volatile uint32_t uiRootTog;
} T_ROOT_CTRL;
...
typedef struct
{
    volatile uint32_t uiXtalCfg;
    volatile uint32_t uiXtalTest;
} T_OSC_REG;
